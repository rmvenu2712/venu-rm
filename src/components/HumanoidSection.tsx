...
const HumanoidSection = () => {
  ...
  return (
    <div
      ...
      style={{ height: '300vh' }}
    >
      <section className="w-full px-4 sm:px-0 h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-background" id="why-humanoid">
        <div className="container px-0  sm:px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            ...
            <h2 className="section-title text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-1 md:mb-2">
              <SplitText text="My Development Approach" />
            </h2>
          </div>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex overflow-hidden  items-center relative justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">

                  <ShinyText text="The vision" className="text-sm font-medium" />
                </div>
              </div>
            ...
            >
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex overflow-hidden items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <ShinyText text="The vision" className="text-sm font-medium" />
                </div>
              </div>
            ...
            >
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Delivering quality code, <span className="text-[#FC4D0A]">on time</span>
                  </h3>
                </div>
              </div>
            </div>
